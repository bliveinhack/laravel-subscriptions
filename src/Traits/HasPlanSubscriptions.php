...
namespace bliveinhack\Subscriptions\Traits;
...
trait HasPlanSubscriptions
{
    ...
    {
        return $this->morphMany(config('bliveinhack.subscriptions.models.plan_subscription'), 'subscriber', 'subscriber_type', 'subscriber_id');
    }
     ...
     *
     * @return \bliveinhack\Subscriptions\Models\PlanSubscription|null
     */
    ...
    public function subscribedPlans(): Collection
    {
        ...
        return app('bliveinhack.subscriptions.plan')->whereIn('id', $planIds)->get();
    }
     ...
     *
     * @return \bliveinhack\Subscriptions\Models\PlanSubscription
     */
