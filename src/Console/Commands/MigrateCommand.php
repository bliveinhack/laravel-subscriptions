...
class MigrateCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'bliveinhack:migrate:subscriptions {--f|force : Force the operation to run when in production.}';
     ...
     * @var string
     */
    protected $description = 'Migrate bliveinhack Subscriptions Tables.';
